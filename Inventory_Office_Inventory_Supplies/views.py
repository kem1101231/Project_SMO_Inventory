...
def acctdetails(request):
    ...
    if offDetails[2] == 'college':
        ...
        reponse = HttpResponseRedirect('/inventory_office/account/departments')
        setSessionData(request, 'theDeptID', offID)
    
    else:
        reponse = HttpResponseRedirect('/inventory_office/account/item_list')
...
def displayItemOfParticular(request):
    ...
    return HttpResponseRedirect('/inventory_office/equipment/list/')  
...
def displayEquipDetails(request):
    ...
    return HttpResponseRedirect('/inventory_office/equipment/details/')    
...
def displayRISDetails(request):
    ...
    return HttpResponseRedirect('/inventory_office/ris/details/') 
...
def setReponse(request, outputPage, pageData1, pageData2, pageData3, pageData4, pageData5):
    ...
    if isSessionValueEmpty(request,'theCookie'):
        ...
        c = {
            ...
            'pageData4': pageData4,
            'pageData5': pageData5,
            'baseSource': 'inventory_office/base.html',
            'urlHead': 'inventory_office',
        
        }

        if any( 30 == code for code in acctType):

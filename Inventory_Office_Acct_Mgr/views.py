...
urlHead = '/inventory_office_acct_mgr'
...
def setReponse(request, outputPage, pageData1, pageData2, pageData3, pageData4, pageData5):
    ...
    if isSessionValueEmpty(request,'theCookie'):
        ...
        c = {
            ...
            'pageData4': pageData4,
            'pageData5': pageData5,
            'baseSource': 'inventory_office_acct_mgr/base.html',
            'urlHead': urlHead,
            'cssActiveMenu' : 'active-menu-inven-acct',
        
        }

        if any( 32 == code for code in acctType):
